...
var materials = {
		...
		'xstarts' : [27,   371,  39,   45,   29,   38,  32,   40,   38, 40,   27,  38,  25,  43,  41 ],
		'ystarts' : [280,   266, 251,  48,   16,  172,  265,  251,  48, 250, 284,  126, 270,  51, 251 ],
		'xends' :   [369,   43,  276,  367,  385, 347,  372,  367, 280, 364, 381,  348, 366, 364, 280],
		'yends' :   [34,   50,   278,  264,  265,  25,   23,   35,  20, 35,   37,  276, 34,  267, 275]
		//'xstarts' : [50], 
		//'ystarts' : [265],
		//'xends' :   [344],
		//'yends' :    [20]
		 ...
		 if(drawing) {
			...
			if (currentRefresh - lastRefresh > (1000/30) ) {
	           ...
	           // ctx_mirror.fill();
				...
				//document.getElementById("status").innerHTML = "Click next to continue.";
			}
		}
